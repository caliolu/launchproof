...
const variants = {
  default: "bg-gradient-to-r from-primary to-purple-500 text-primary-foreground hover:brightness-110",
  secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/90",
  outline: "border border-border bg-background hover:bg-primary/5 hover:text-accent-foreground",
